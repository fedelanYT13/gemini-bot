...
let drm1 = ""
let drm2 = ""
let rtx = `┌  ꕥ  *Escanea este QR para convertirte en un Sub Bot*\n`
rtx += `│  ➪  Pasos\n`
rtx += `│  ➪  *1*: Haga click en los 3 puntos (arriba a la derecha)\n`
rtx += `│  ➪  *2*: Toque *Dispositivos vinculados*\n`
rtx += `│  ➪  *3*: Seleccione *Vincular un dispositivo*\n`
rtx += `└  ➪  *4*: Escanee el código QR mostrado aquí\n\n`
rtx += `*☽ AVISO:* Este código QR expira en *45 segundos* y solo funciona en el número que lo solicitó.`

let rtx2 = `┌  ꕥ  *Usa este Código para convertirte en un Sub Bot*\n`
rtx2 += `│  ➪  Pasos\n`
...
rtx2 += `└  ➪  *4*: Escriba el Código\n\n`
rtx2 += `*☽ AVISO:* Este Código solo funciona en el número en el que se solicitó.`
